...
// ══════════════════════════════════════════════════════
inline constexpr uint64_t SMUID          = 0x0000000000000000FF;  ///< Session Manager UID (세션 매니저 호출 대상)
...
inline constexpr uint64_t LOCKING_RANGE1        = 0x0000080200030001;  ///< Locking Range 1 — 사용자 정의 잠금 범위 1
inline constexpr uint64_t LOCKING_RANGE2        = 0x0000080200030002;  ///< Locking Range 2 — 사용자 정의 잠금 범위 2
/// @}
...
/// @{
inline constexpr uint64_t ACE_LOCKING_RANGE_SET_RDLOCKED  = 0x0000000800030001;  ///< Locking Range 읽기 잠금 설정 ACE
inline constexpr uint64_t ACE_LOCKING_RANGE_SET_WRLOCKED  = 0x0000000800030002;  ///< Locking Range 쓰기 잠금 설정 ACE
inline constexpr uint64_t ACE_LOCKING_GLOBALRANGE_SET_RDLOCKED = 0x0000000800000001;  ///< Global Range 읽기 잠금 설정 ACE
inline constexpr uint64_t ACE_LOCKING_GLOBALRANGE_SET_WRLOCKED = 0x0000000800000002;  ///< Global Range 쓰기 잠금 설정 ACE
/// @}
